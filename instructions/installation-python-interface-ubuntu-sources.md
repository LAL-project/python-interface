...
LAL is interfaced to [Python 3.12](https://www.python.org/) via [SWIG 4.2.1](http://www.swig.org/). In order to compile the interface, you need to have `python3`, `SWIG` and `make` tools installed in your system. Optionally, you may install `bibtex` and `doxygen`.
